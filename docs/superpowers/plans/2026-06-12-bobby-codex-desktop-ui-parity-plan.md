...
- Right dock still exposes too many non-parity tabs
- Files panel behavior still differs materially from Codex
- Search, plugins, automations, and history still feel like page switches instead of one shell
...
- [ ] **Step 1: Lock the visible dock contract in tests**
...
- [ ] **Step 2: Reduce dock navigation to the four screenshot-backed entries**
...
- [ ] **Step 3: Make dock persistence restore cleanly**
...
- [ ] **Step 1: Codify file tool behavior in tests**
...
- [ ] **Step 2: Rebuild the files panel around Codex semantics**
...
- [ ] **Step 1: Freeze shell continuity in tests**
...
- [ ] **Step 1: Define resume expectations in tests**
...
- [ ] **Step 2: Persist only meaningful shell context**
...
1. Task 1: W6 Dock parity
2. Task 2: W7 Files parity
3. Task 3: W8 Unified shell for secondary screens
4. Task 4: W9 Persistence and resume
5. Task 5: W10 Visual and responsive cleanup
6. Task 6: Final acceptance sweep
